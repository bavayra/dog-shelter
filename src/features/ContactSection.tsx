  ...
  return (
    <section id="contact" className="bg-primary-200 pt-8 pb-10 md:px-6">
      ...
      <div className="4xl:gap-30 5xl:w-400 4xl:w-300 tablet-lg:grid tablet-lg:grid-cols-2 tablet-lg:gap-4 3xl:gap-20 relative flex justify-center md:m-6 md:mx-auto lg:w-200 lg:gap-10 xl:w-250">
        ...
        <div className="glass-card 3xl:w-120 tablet-lg:flex 5xl:px-6 tablet-lg:w-80 5xl:w-160 tablet-lg:flex-col tablet-lg:gap-4 tablet-lg:self-center tablet-lg:ml-8 mb-10 hidden rounded-2xl py-8 xl:w-120">
          <p className="typography-large tablet-lg:text-xl 3xl:text-2xl 5xl:text-3xl px-4 text-center text-xl md:block md:font-normal xl:text-2xl">
