...
const DogFilters = ({
    ...
    return options.map((option) => {
      ...
      return (
        <button
          ...
          className={`typography-small tablet-sm:text-base 3xl:text-base 4xl:text-xl 5xl:text-2xl rounded-lg px-3 py-2 font-medium transition-colors sm:text-sm md:text-sm ${
            isActive
  ...
  return (
    <section
      className="3xl:w-300 3xl:mx-auto 4xl:w-400 4xl:mx-auto 5xl:w-440 mb-8 rounded-lg bg-white px-4 py-6 shadow-md sm:mx-4 md:px-8 xl:mx-auto xl:w-250 2xl:mx-auto 2xl:w-280"
    ...
    >
      ...
      <div className="5xl:gap-10 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        <div>
          <label className="typography-body 3xl:text-xl 4xl:text-3xl 4xl:font-semibold mb-2 block sm:text-lg md:text-xl">
            Age:
          </label>
      ...
      <div className="xs:mt-6 5xl:mt-16 mt-5 flex justify-end xl:mt-10">
        <Button
          ...
          variant="filter"
          active={false}
          className="tablet-sm:text-base 4xl:py-4 xs:pt-3 4xl:px-8 text-xs"
        >
          RESET FILTERS
        </Button>
      </div>
