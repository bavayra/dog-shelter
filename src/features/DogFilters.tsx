    ...
    return options.map((option) => {
      ...
      return (
        <button
          ...
          className={`typography-small tablet-sm:text-base 3xl:text-lg 4xl:text-xl 5xl:text-2xl rounded-lg px-3 py-2 font-medium transition-colors sm:text-sm md:text-sm ${
            isActive
