  ...
  return (
    ...
    >
      ...
      <DecorativeCircle
        ...
        opacity={90}
        zIndex={0}
        className="about-circle-xs phone:translate-y-1/7 phone-lg:-translate-y-1/6 tablet-sm:-translate-y-1/6 tablet-lg:translate-y-1/3 tablet-lg:-translate-x-1/10"
      />
