  ...
  return (
    ...
    >
      ...
      <DecorativeCircle
        ...
        opacity={90}
        zIndex={0}
        className="about-circle-xs phone:translate-y-1/2 phone-lg:translate-y-1/2 tablet-sm:translate-y-1/3 tablet-lg:translate-y-1/2 tablet-lg:-translate-x-1/10"
      />
      <div className="container mx-auto px-4">
        ...
        <div className="relative mx-auto my-2">
          ...
          />
          <div className="about-content bg-primary-100 typography-body border-primary-300 relative z-10 mx-auto rounded-2xl border-2 text-center md:mx-auto">
            <p>
