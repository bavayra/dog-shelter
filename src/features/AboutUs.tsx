  ...
  return (
    <section id="about-us" className="bg-primary-50 py-8">
      <div className="container mx-auto px-4">
        <h2 className="typography-h2 xs:text-5xl tablet-lg:text-8xl 4xl:mt-6 5xl:mb-12 xs:pt-2 4xl:text-9xl z-12 mb-4 text-center md:mb-8 md:text-7xl xl:text-8xl">
          About Us
        </h2>
