...
const HowToHelp = () => {
  return (
    <section
      id="help"
      className="bg-primary-50 border-b-primary-500 tablet-sm:min-h-[70vh] tablet-lg:min-h-[60vh] 5xl:min-h-[82vh] relative z-1 min-h-[75vh] scroll-mt-20 overflow-hidden border-b-3 pt-6 pb-30 sm:min-h-[68vh] sm:pt-10 md:min-h-[60vh] lg:min-h-screen xl:min-h-screen"
    >
      <div className="z-10 container mx-auto px-4">
        <h2 className="typography-h2 xs:text-4xl xs:pt-4 tablet-sm:text-5xl tablet-lg:text-6xl 4xl:pt-10 4xl:pb-4 3xl:mt-10 tablet-sm:mt-0 4xl:text-8xl mb-6 text-center sm:mt-0 sm:pt-0 md:text-5xl lg:text-7xl 2xl:mb-10">
          How to Help ROTVODOM
        </h2>
        <div className="tablet-sm:px-4 3xl:max-w-4xl tablet-lg:mb-6 4xl:max-w-5xl 5xl:max-w-7xl 5xl:px-6 5xl:mb-14 mx-auto mb-6 max-w-3xl text-center sm:px-6 md:mb-4 md:px-22">
          <p className="typography-body xs:text-lg tablet-sm:text-xl tablet-lg:text-2xl 4xl:text-4xl 5xl:text-5xl mb-2 leading-relaxed lg:text-3xl">
            Our shelter relies{' '}
          ...
          <p className="typography-body xs:text-lg tablet-sm:text-xl tablet-lg:text-2xl 4xl:text-4xl 5xl:text-5xl leading-relaxed lg:text-3xl">
