  ...
  return (
    ...
    >
      <div className="z-10 container mx-auto px-4">
        <h2 className="typography-h2 xs:text-4xl tablet-sm:text-5xl 3xl:mt-10 tablet-sm:mt-0 mb-6 text-center lg:text-7xl 2xl:mb-10">
          How to Help ROTVODOM
        </h2>
        <div className="tablet-sm:px-4 3xl:max-w-4xl mx-auto mb-6 max-w-3xl text-center md:mb-6 md:px-12">
          ...
          <p className="typography-body xs:text-lg tablet-sm:text-2xl leading-relaxed lg:text-3xl">
