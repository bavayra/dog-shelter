...
const DogCard = memo((dog: Dog) => {
  ...
  return (
    <>
      <article
        className="3xl:h-156 4xl:h-auto 4xl:w-md 5xl:h-auto 4xl:mx-auto flex h-full cursor-pointer flex-col overflow-hidden rounded-lg bg-neutral-50 shadow-md transition-all duration-300 hover:scale-[1.02] hover:shadow-xl sm:mx-4 lg:h-150 2xl:h-150"
      ...
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col p-4">
          ...
          <div className="min-h-0 flex-1">
            <div className="typography-small 3xl:text-xl 5xl:text-2xl tablet-sm:text-lg tablet-lg:text-lg 5xl:line-clamp-7 2xl:line-clamp-auto 4xl:line-clamp-11 mb-4 line-clamp-5 overflow-y-hidden text-sm tracking-wide sm:text-base md:text-base lg:mb-4 lg:line-clamp-7 2xl:p-2">
