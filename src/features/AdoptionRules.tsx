...
const AdoptionRules = () => {
  ...
  return (
    <section id="adoption-rules" className="relative z-1 bg-neutral-50 py-6">
      ...
      <div className="xl2:gap-x-16 3xl:gap-x-0 3xl:max-w-5xl 4xl:max-w-6xl 5xl:max-w-7xl mx-auto max-w-4xl space-y-4 lg:grid lg:grid-cols-2 lg:gap-6 xl:gap-x-6">
