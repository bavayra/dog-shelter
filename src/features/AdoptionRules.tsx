  ...
  return (
    <section id="adoption-rules" className="relative z-1 bg-neutral-50 py-6">
      <div className="container mx-auto px-4 sm:mt-4">
        ...
        <p className="typography-body 4xl:mt-4 xs:text-lg 5xl:text-5xl tablet-sm:text-xl 5xl:w-420 5xl:px-60 mx-auto mt-4 mb-6 text-center sm:text-lg md:px-16 md:text-2xl md:tracking-tight lg:text-3xl xl:px-34 2xl:my-8 2xl:w-5xl">
