...
const DogGrid = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-4 md:px-10">
      <DogFilters
        filters={filters}
      ...
      {isLoading ? (
        ...
        <>
          <div className="grid grid-cols-1 gap-6 transition-all md:grid-cols-2 lg:grid-cols-3 lg:gap-x-2 lg:gap-y-10">
