...
const Button = ({
  ...
  const variantStyles: Record<ButtonVariant, string> = {
    primary:
      'bg-primary-700 text-white text-xs py-2 5xl:px-14 hover:bg-primary-900 hover:scale-105 focus:ring-primary-500 active:bg-primary-800',
    secondary:
  ...
  const sizeStyles: Record<ButtonSize, string> = {
    small:
      'px-3 py-1.5 text-sm xs:text-base 4xl:text-xl tablet-lg:text-2xl md:text-lg 5xl:text-3xl',
    medium:
      'px-4 py-2 text-base xs:text-lg sm:px-6 sm:py-2 tablet-lg:text-lg md:text-xl lg:text-base 3xl:text-xl 5xl:text-2xl',
    large:
      'px-4 py-1 text-lg 5xl:text-3xl xs:text-base md:text-lg xs:py-2 3xl:text-2xl xs:px-8 tablet-sm:text-xl tablet-lg:text-xl 4xl:text-2xl tablet-sm:py-2',
  };
  return (
    <button
