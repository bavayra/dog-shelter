...
const Button = ({
  ...
  const variantStyles: Record<ButtonVariant, string> = {
    primary:
      'bg-primary-700 text-white text-xs py-2 5xl:px-14  hover:bg-primary-900 md:text-lg tablet-lg:text-2xl hover:scale-105 focus:ring-primary-500 active:bg-primary-800',
    secondary:
    ...
    outline:
      'bg-primary-200 border-2 border-primary-500 text-primary-700  5xl:text-2xl hover:scale-105 hover:bg-primary-100 focus:ring-primary-200 shadow-md active:bg-primary-300',
    filter: active
  ...
  const sizeStyles: Record<ButtonSize, string> = {
    ...
    medium:
      'px-4 py-2 text-base xs:text-lg sm:text-lg sm:px-6 sm:py-2 tablet-lg:text-lg md:text-xl lg:text-base 3xl:text-xl 5xl:text-2xl',
    large:
      'px-4 py-1 text-lg 4xl:text-2xl 5xl:text-3xl xs:text-base xs:py-2 3xl:text-2xl xs:px-8 sm:text-base tablet-sm:text-xl tablet-lg:text-xl 4xl:text-2xl tablet-sm:py-2',
  };
  return (
    <button
