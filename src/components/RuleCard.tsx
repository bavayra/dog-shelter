...
const RuleCard = ({ number, text }: RuleCardProps) => {
  return (
    <div className="xs:mx-6 3xl:w-lg 3xl:p-6 5xl:w-xl mx-2 flex h-full justify-center rounded-lg bg-white px-6 py-4 text-center shadow-md sm:mx-8 md:mx-16 lg:mx-4 2xl:mx-auto 2xl:w-md">
