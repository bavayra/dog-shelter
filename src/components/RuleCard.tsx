...
const RuleCard = ({ number, text }: RuleCardProps) => {
  return (
    <div className="xs:mx-6 3xl:max-w-xl 3xl:p-6 4xl:px-8 5xl:w-xl 5xl:px-4 tablet-lg:w-lg tablet-lg:py-6 tablet-lg:mx-auto mx-2 flex h-full justify-center rounded-lg bg-white px-6 py-4 text-center shadow-md sm:mx-8 md:mx-16 lg:mx-4 lg:max-w-sm 2xl:mx-auto 2xl:w-md">
