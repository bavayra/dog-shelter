        ...
        <div className="tablet-lg:gap-58 flex flex-row items-center justify-evenly gap-30 md:gap-50 lg:gap-6">
          <div className="flex min-w-0 flex-row items-center gap-1 sm:gap-2">
            ...
            <div className="flex min-w-0 items-center">
              <h1 className="text-primary-500 xs:text-xl 6xl:text-4xl tablet-sm:text-3xl 5xl:text-5xl min-w-0 truncate text-sm leading-tight font-bold sm:text-2xl lg:text-2xl 2xl:text-3xl">
                {APP_NAME}
              </h1>
            </div>
          </div>
          ...
          >
            {headerLinks.map((link) => (
              <a
                key={link.id}
                href={link.href}
                className="hover:text-primary-900 hover:bg-primary-200 6xl:text-2xl 5xl:text-3xl 4xl:text-2xl 3xl:text-xl mx-0 py-3 text-lg font-medium text-neutral-700 transition-transform hover:scale-105 hover:rounded-lg hover:font-bold md:rounded-full md:px-4 md:py-1 md:font-bold lg:font-semibold"
