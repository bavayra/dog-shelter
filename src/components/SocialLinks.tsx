...
const SocialLinks = ({
  ...
  const sizeClasses = {
    ...
    md: 'w-12  h-12 xs:w-14 xs:h-14 md:w-12 md:h-12 4xl:w-16 4xl:h-16',
  };
      ...
      {socialNetworks.map((social) => (
        ...
        >
          <Icon
            ...
            className={`${iconColor} xs:w-6 xs:h-6 5xl:w-16 5xl:h-16 tablet-lg:w-10 tablet-lg:h-10 4xl:w-12 4xl:h-12 sm:h-10 sm:w-10 md:h-8 md:w-8`}
            aria-hidden="true"
          />
        </a>
      ))}
