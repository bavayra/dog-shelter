...
const SocialLinks = ({
  ...
  const sizeClasses = {
    sm: 'w-10 h-10 xs:w-12 xs:h-12 sm:w-14 sm:h-14 tablet-lg:w-20 tablet-lg:h-20 4xl:w-24 4xl:h-24 5xl:w-30 5xl:h-30',
      ...
      {socialNetworks.map((social) => (
        ...
        >
          <Icon
            ...
            className={`${iconColor} xs:w-7 xs:h-7 5xl:w-16 5xl:h-16 tablet-lg:w-10 tablet-lg:h-10 4xl:w-12 4xl:h-12 md:h-8 md:w-8`}
            aria-hidden="true"
          />
        </a>
      ))}
