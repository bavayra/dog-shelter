...
const Footer = () => {
  return (
    <footer className="bg-primary-900 py-6 text-neutral-50">
      <div className="tablet-lg:grid-cols-2 4xl:gap-80 tablet-lg:gap-40 container mx-auto mb-6 grid grid-cols-1 justify-items-center gap-6 px-4 md:mb-2 md:w-170 md:grid-cols-3 md:gap-5 lg:gap-12">
        <div>
