        ...
        <main className="flex-1">
          ...
          <section id="pets" className="bg-primary-50 scroll-mt-10">
            <div className="container mx-auto px-4">
              <h2
                id="pets-heading"
                className="typography-h1 xs:text-5xl 4xl:text-9xl m-0 pt-10 text-center md:pb-8 md:text-7xl lg:text-8xl"
              >
                Our Pets
              </h2>
            </div>
          ...
          <Suspense fallback={<LoadingSpinner message="Loading content..." />}>
            ...
            <div className="relative">
              ...
              <DecorativeCircle
                ...
                opacity={90}
                zIndex={10}
                className="tablet-lg:translate-x-[30%] 4xl:-ml-11 4xl:mt-8 tablet-lg:mt-4 md:translate-x-3/5 md:translate-y-1/7 xl:translate-x-[75%] 2xl:translate-x-[135%]"
              />
            </div>
            <AboutUs />
            <ContactSection />
