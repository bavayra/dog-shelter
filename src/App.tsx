        ...
        <main className="flex-1">
          ...
          >
            <svg
              ...
              aria-hidden="true"
              role="img"
              className="z-0 pointer-events-none absolute right-2 top-3 w-96 md:w-96 transform -rotate-4 drop-shadow-2xl opacity-95 text-primary-300"
            >
              <path
            ...
            <h2 className=" relative z-10 text-5xl text-primary-700 font-medium text-center mt-10 mx-5">
            ...
            <div className="flex relative z-10 justify-center  ">
              <h3 className=" text-xl  text-center text-primary-500 mt-10 font-semibold">
          ...
          <section id="our-pets" className="bg-primary-50 py-0">
            <div className="container mx-auto px-4">
              <h2 className="text-6xl text-primary-500 font-bold text-center -mt-2 mb-4">
                Our Pets
              </h2>
            </div>
            <DogGrid />
