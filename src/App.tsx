    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1">
          <section
            id="hero"
            className="hero-vh from-primary-200 tablet-lg:min-h-[calc(var(--vh,1vh)*100-10rem)] 6xl:min-h-[calc(var(--vh,1vh)*100-5.5rem)] 5xl:min-h-[calc(var(--vh,1vh)*100-6rem)] 4xl:min-h-[calc(var(--vh,1vh)*100-5rem)] to-primary-50 border-primary-500 xs:min-h-[calc(var(--vh,1vh)*100-3rem)] tablet-sm:min-h-[calc(var(--vh,1vh)*100-6rem)] relative flex min-h-[calc(var(--vh,1vh)*100-2rem)] flex-col overflow-hidden border-b-3 bg-linear-to-b px-4 pt-6 pb-6 shadow-md min-[425px]:min-h-[calc(var(--vh,1vh)*100-5rem)] sm:min-h-[calc(var(--vh,1vh)*100-4rem)] md:min-h-[calc(var(--vh,1vh)*100-9rem)] md:p-10 lg:min-h-[calc(var(--vh,1vh)*100-72px)] xl:h-[calc(var(--vh,1vh)*100-10rem)]"
          >
