        ...
        <main className="flex-1">
          ...
          >
            ...
            <DecorativeCircle
              ...
              left="0"
              opacity={70}
              className="tablet-sm:translate-y-full 4xl:translate-y-[40%] 5xl:-mt-4 -translate-x-1/2 translate-y-[80%] sm:translate-y-[110%] md:translate-y-2/3 lg:-mt-10"
            />
            ...
            <img
              src={RottweilerImage}
              className="xs:h-72 xs:w-72 xs:-mr-10 5xl:h-176 image-5xl-mid tablet-sm:w-96 tablet-sm:h-96 4xl:h-130 4xl:w-130 absolute right-0 bottom-0 z-3 h-54 w-54 object-contain sm:h-84 sm:w-84 md:h-90 md:w-90 2xl:h-110 2xl:w-110"
          ...
          <section id="pets" className="bg-primary-50 scroll-mt-10">
            <div className="container mx-auto px-4">
              <h2
                id="pets-heading"
                className="typography-h1 xs:text-5xl tablet-sm:text-7xl 4xl:text-9xl 5xl:py-20 m-0 pt-10 text-center md:pb-8 md:text-7xl lg:text-8xl"
              >
                Our Pets
              </h2>
            </div>
          ...
          <Suspense fallback={<LoadingSpinner message="Loading content..." />}>
            ...
            <div className="relative">
              <DecorativeCircle
                ...
                opacity={40}
                zIndex={10}
                className="xs:translate-y-2/5 xs:-translate-x-1/3 tablet-lg:translate-x-[10%] tablet-lg:mt-4 4xl:-ml-12 md:translate-x-1/4 xl:translate-x-1/3 2xl:translate-x-2/3"
              />
              <DecorativeCircle
                size={16}
                mdSize={24}
                ...
                opacity={90}
                zIndex={10}
                className="tablet-lg:translate-x-[30%] xs:translate-y-[145%] xs:-translate-x-[5%] 5xl:-ml-8 4xl:-ml-11 4xl:mt-8 tablet-lg:mt-4 md:translate-x-3/5 md:translate-y-1/7 xl:translate-x-[75%] 2xl:translate-x-[135%]"
              />
            </div>
            <AboutUs />
            <ContactSection />
