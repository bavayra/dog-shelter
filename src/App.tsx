      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1">
          ...
          >
            ...
            <img
              src={RottweilerImage}
              className="xs:h-72 xs:w-72 xs:-mr-10 5xl:h-176 image-5xl-mid tablet-sm:w-96 tablet-sm:h-96 4xl:h-130 4xl:w-130 absolute right-0 bottom-0 z-3 h-54 w-54 object-contain sm:h-84 sm:w-84 md:h-104 md:w-104 lg:h-100 lg:w-100 2xl:h-110 2xl:w-110"
          ...
          <Suspense fallback={<LoadingSpinner message="Loading content..." />}>
            ...
            <div className="relative">
              <DecorativeCircle
                ...
                opacity={40}
                zIndex={10}
                className="xs:translate-y-2/5 xs:-translate-x-1/3 tablet-lg:-translate-x-[10%] tablet-lg:mt-4 4xl:-ml-12 3xl:ml-4 3xl:mt-4 md:translate-x-[5%] lg:-mt-2 lg:translate-x-[5%] xl:translate-x-1/4 xl:translate-y-[20%] 2xl:translate-x-1/2"
              />
              <DecorativeCircle
                size={16}
                mdSize={30}
                ...
                opacity={90}
                zIndex={10}
                className="tablet-lg:translate-x-[25%] xs:translate-y-[145%] 3xl:ml-6 3xl:mt-4 xs:-translate-x-[5%] 5xl:-ml-8 4xl:-ml-11 4xl:mt-8 tablet-lg:mt-4 md:translate-x-[50%] md:translate-y-[110%] lg:-mt-2 lg:translate-x-[50%] xl:translate-x-[85%] xl:translate-y-[75%] 2xl:translate-x-[135%]"
              />
            </div>
            <AboutUs />
            <ContactSection />
